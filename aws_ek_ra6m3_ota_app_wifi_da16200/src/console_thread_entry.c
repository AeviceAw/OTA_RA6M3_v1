...
#ifdef OG1
char mqtt_host[128] = "a3diwcjwt78ey7-ats.iot.ap-southeast-1.amazonaws.com\r";
char mqtt_client_identifier[128] = "ra6m3_ota_demo_thing\r";
char aevice_wifi[64] = "AU-Router 201607130713\r";

char dd_rootca[2048] =  "-----BEGIN CERTIFICATE-----\n"\
...
char ddevice_cert[2048] = "-----BEGIN CERTIFICATE-----\n"\
...
char ddevice_key[2048] = "-----BEGIN RSA PRIVATE KEY-----\n"\
...
char pub_sign_key[256] = "-----BEGIN PUBLIC KEY-----\n"\
...
void write_certs(void)
{
    ...
    memcpy(g_write_buffer,ddevice_cert,sizeof(ddevice_cert));
    credentials = CERTIFICATE;
    err = aws_certficate_write (credentials);
    memcpy(g_write_buffer,ddevice_key,sizeof(ddevice_key));
    credentials = PRIVATE_KEY;
    err = aws_certficate_write (credentials);
    memcpy(g_write_buffer,pub_sign_key,sizeof(pub_sign_key));
