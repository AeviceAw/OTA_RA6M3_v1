...
#include "task.h"
#include "semphr.h"
extern void ota_thread_create(void);
...
extern void dataprocess_thread_create(void);
extern TaskHandle_t dataprocess_thread;
extern void ssidpw_thread_create(void);
extern TaskHandle_t ssidpw_thread;
extern void rgb_thread_create(void);
extern TaskHandle_t rgb_thread;
extern void subscribe_thread_create(void);
extern TaskHandle_t subscribe_thread;
extern void publish_thread_create(void);
extern TaskHandle_t publish_thread;
...
int main(void)
{
    ...
    wifi_thread_create ();
    uart_thread_create ();
    dataprocess_thread_create ();
    ssidpw_thread_create ();
    rgb_thread_create ();
    subscribe_thread_create ();
    publish_thread_create ();
