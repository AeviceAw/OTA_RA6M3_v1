...
gpt_instance_ctrl_t g_uart_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_uart_timer_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_uart_timer_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg                   = &g_uart_timer_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_uart_timer_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x1d4c0,
  .duty_cycle_counts = 0xea60, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = g_uart_timer_callback,
...
const timer_instance_t g_uart_timer =
{ .p_ctrl = &g_uart_timer_ctrl, .p_cfg = &g_uart_timer_cfg, .p_api = &g_timer_on_gpt };
