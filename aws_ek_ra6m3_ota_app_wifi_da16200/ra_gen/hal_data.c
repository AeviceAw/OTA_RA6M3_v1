...
{ .clock_source = RTC_CLOCK_SOURCE_LOCO, .freq_compare_value = 255, .p_err_cfg = &g_rtc_err_cfg, .p_callback =
          rtc_callback,
  .p_context = NULL, .p_extend = NULL, .alarm_ipl = (BSP_IRQ_DISABLED), .periodic_ipl = (0), .carry_ipl = (12),
...
{ .p_ctrl = &g_iwdt_ctrl, .p_cfg = &g_iwdt_cfg, .p_api = &g_wdt_on_iwdt };
adc_instance_ctrl_t g_adc_current_detect_ctrl;
const adc_extended_cfg_t g_adc_current_detect_cfg_extend =
...
const adc_cfg_t g_adc_current_detect_cfg =
{ .unit = 0, .mode = ADC_MODE_SINGLE_SCAN, .resolution = ADC_RESOLUTION_12_BIT, .alignment =
  ...
  .p_context = &NULL,
#endif
  .p_extend = &g_adc_current_detect_cfg_extend,
...
#if ((0) | (0))
const adc_window_cfg_t g_adc_current_detect_window_cfg =
{
    .compare_mask        =  0,
    .compare_mode_mask   =  0,
...
#endif
const adc_channel_cfg_t g_adc_current_detect_channel_cfg =
{ .scan_mask = 0,
  .scan_mask_group_b = 0,
...
#if ((0) | (0))
    .p_window_cfg        = (adc_window_cfg_t *) &g_adc_current_detect_window_cfg,
#else
  .p_window_cfg = NULL,
#endif
        };
/* Instance structure to use this module. */
const adc_instance_t g_adc_current_detect =
{ .p_ctrl = &g_adc_current_detect_ctrl, .p_cfg = &g_adc_current_detect_cfg, .p_channel_cfg =
          &g_adc_current_detect_channel_cfg,
  .p_api = &g_adc_on_adc };
...
sci_spi_instance_ctrl_t g_sram_ctrl;

/** SPI extended configuration */
const sci_spi_extended_cfg_t g_sram_cfg_extend =
{ .clk_div =
{
/* Actual calculated bitrate: 15000000. */.cks = 0,
  .brr = 1, .mddr = 0, } };

const spi_cfg_t g_sram_cfg =
...
#undef RA_NOT_DEFINED
  .p_callback = sram_callback,
  .p_context = NULL, .rxi_irq = VECTOR_NUMBER_SCI6_RXI, .txi_irq = VECTOR_NUMBER_SCI6_TXI, .tei_irq =
          VECTOR_NUMBER_SCI6_TEI,
  .eri_irq = VECTOR_NUMBER_SCI6_ERI, .rxi_ipl = (2), .txi_ipl = (2), .tei_ipl = (2), .eri_ipl = (2), .p_extend =
          &g_sram_cfg_extend, };
/* Instance structure to use this module. */
const spi_instance_t g_sram =
...
#endif
  .ipl = (0),
  .p_extend = &g_i2c_rgb_master_extend, };
/* Instance structure to use this module. */
const i2c_master_instance_t g_i2c_rgb_master =
{ .p_ctrl = &g_i2c_rgb_master_ctrl, .p_cfg = &g_i2c_rgb_master_cfg, .p_api = &g_i2c_master_on_iic };
crc_instance_ctrl_t g_crc_ctrl;
const crc_cfg_t g_crc_cfg =
{ .polynomial = CRC_POLYNOMIAL_CRC_8, .bit_order = CRC_BIT_ORDER_LMS_MSB, .snoop_address = 0x003, .p_extend = NULL, };
...
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x7270e00,
  .duty_cycle_counts = 0x3938700, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = g_user_timer_cb,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
